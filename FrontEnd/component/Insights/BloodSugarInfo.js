...
const BloodSugarInfo = () => {
  return (
    <ScrollView contentContainerStyle={styles.container}>
      ...
      <Text style={styles.text}>Fasting Blood Sugar Test</Text>
      <Text style={styles.text}>
      ...
      <Text style={styles.text}>Postprandial Blood Sugar Test</Text>
      <Text style={styles.text}>
      ...
      <Text style={styles.text}>Random Blood Sugar Test</Text>
      <Text style={styles.text}>
